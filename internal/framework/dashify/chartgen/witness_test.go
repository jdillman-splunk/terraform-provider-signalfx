...
import (
	...
	generatedcharts "github.com/splunk-terraform/terraform-provider-signalfx/internal/framework/dashify/charts"
...
func TestEveryGeneratedMappingHasAnOllyValidatedWitness(t *testing.T) {
	...
	schemasDirectory := filepath.Join(repository, "internal", "framework", "dashify", "charts", "schemas")
